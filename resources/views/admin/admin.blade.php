                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="html/index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="{{ asset('material/images/logo.png') }}"
                                srcset="{{ asset('material/images/logo2x.png 2x') }}" alt="logo">
                            <img class="logo-dark logo-img" src="{{ asset('material/images/logo-dark.png') }}"
                                srcset="{{ asset('material/images/logo-dark2x.png 2x') }}" alt="logo-dark">
                            <img class="logo-small logo-img logo-img-small"
                                src="{{ asset('material/images/logo-small.png') }}"
                                srcset="{{ asset('material/images/logo-small2x.png 2x') }}" alt="logo-small">
                        </a>
                    </div>
                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="html/lms/index.html" class="nk-menu-link">
                                        ...
                                        <span class="nk-menu-text">LMS Panel</span><span
                                            class="nk-menu-badge">HOT</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-heading">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="html/index.html" class="logo-link">
                                    ...
                                    <img class="logo-dark logo-img"
                                        src="{{ asset('material/images/logo-dark.png') }}"
                                        srcset="{{ asset('material/images/logo-dark2x.png 2x') }}" alt="logo-dark">
                                </a>
                            </div><!-- .nk-header-brand -->
                                    ...
                                    <li class="dropdown language-dropdown d-none d-sm-block mr-n1">
                                        <a href="#" class="dropdown-toggle nk-quick-nav-icon"
                                            ...
                                            <div class="user-avatar xs border border-light">
                                                <img src="{{ asset('material/images/flags/english-sq.png') }}"
                                                    alt="">
                                            </div>
                                        </a>
                                            ...
                                            <ul class="language-list">
                                                <li>
                                                    <a href="#" class="language-item">
                                                        <img src="{{ asset('material/images/flags/english.png') }}"
                                                ...
                                                <li>
                                                    <a href="#" class="language-item">
                                                        <img src="{{ asset('material/images/flags/spanish.png') }}"
                                                            alt="" class="language-flag">
                                                ...
                                                <li>
                                                    <a href="#" class="language-item">
                                                        <img src="{{ asset('material/images/flags/french.png') }}"
                                                            alt="" class="language-flag">
                                                ...
                                                <li>
                                                    <a href="#" class="language-item">
                                                        <img src="{{ asset('material/images/flags/turkey.png') }}"
                                                            alt="" class="language-flag">
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2021 DashLite. Template by <a
