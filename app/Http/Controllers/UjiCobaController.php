...
use App\Repository\UjiCoba\UjiCobaRepository;
use Illuminate\Http\Request;

class UjiCobaController extends Controller
{
    protected $ujicobaRepository;
    public function __construct(UjiCobaRepository $ujicobaRepository)
    {
        $this->ujicobaRepository = $ujicobaRepository;
    }
